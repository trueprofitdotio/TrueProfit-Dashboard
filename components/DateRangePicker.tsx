...
const DateRangePicker: React.FC<DateRangePickerProps> = ({ value, onChange, onPresetSelect }) => {
    ...
    return (
        <div className="relative w-full" ref={containerRef}>
            <button type="button" onClick={() => setIsOpen(!isOpen)} className="w-full bg-white text-left p-2.5 border border-slate-300 focus:outline-none focus:ring-1 focus:ring-[var(--accent-color)] flex justify-between items-center h-[42px]">
            ...
            {isOpen && (
                <div className="absolute z-20 mt-1 bg-white shadow-lg border border-slate-200 p-4" onMouseLeave={() => setHoverDate(null)}>
                    <div className="flex">
